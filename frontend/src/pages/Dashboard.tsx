...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="px-4 py-6">
      ...
      <div
        className={`overflow-hidden shadow-xl rounded-2xl mb-8 transition-all duration-300 ${
          saldoNegativo
      ...
      >
        <div className="p-5 sm:p-8 relative">
          <div className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 rounded-full p-3 sm:p-4">
          ...
          <div className="pr-16 sm:pr-24 min-w-0">
              <h3
                className={`text-sm sm:text-lg font-semibold uppercase tracking-wide ${
                  saldoNegativo ? 'text-red-100' : 'text-blue-100'
                }`}
              >
                Saldo en Bolsa
              </h3>
              <p className="text-[clamp(2rem,10vw,3.6rem)] leading-none font-bold text-white mt-2 sm:mt-3 whitespace-nowrap">
